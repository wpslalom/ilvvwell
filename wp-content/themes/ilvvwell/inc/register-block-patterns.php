 ...
 * @return void
 */
function wp_ilvvwell_starter_register_block_patterns() {
	...
	register_block_pattern_category(
		'images',
		array( 'label' => esc_html__( 'Images', 'ilvvwell' ) )
	);

}
add_action( 'init', 'wp_ilvvwell_starter_register_block_patterns', 9 );
 ...
 * @return void
 */
function wp_ilvvwell_starter_unregister_patterns() {
	unregister_block_pattern( 'core/query-small-posts' );
	unregister_block_pattern( 'core/query-large-title-posts' );
	unregister_block_pattern( 'core/query-offset-posts' );
	unregister_block_pattern_category( 'header' );
}
add_action( 'init', 'wp_ilvvwell_starter_unregister_patterns', 10 );
